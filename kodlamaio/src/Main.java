...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        courseManager.add(new Course(4, "Yazılım Geliştirici Yetiştirme Kampı (JavaScript)", 1, 1, "javascript_camp.png", 95.99));
        courseManager.add(new Course(5, "Yazılım Geliştirici Yetiştirme Kampı (Python)", 1, 1, "python_camp.png", 0.0));
